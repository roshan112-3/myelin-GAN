...
# TODO: Remember to use debug mode
if opt.debug:
    opt.display_freq = 1
    opt.print_freq = 1
    opt.niter = 1
...
for epoch in range(start_epoch, opt.niter + opt.niter_decay + 1):
    ...
    for i, data in enumerate(dataset, start=epoch_iter):
        ...
        ###### 20180930: New interface for training a full step
        loss_dict, generated = model.module.train_one_step(data, save_fake)
        # loss_dict, generated = model.train_one_step(data, save_fake)
        ###### 20180930: Finished
