...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--model', type=str, default='pose2vid', help='which model to use')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./datasets/cardio_dance_512/') 
